...
![](/Users/patriciaobrien/DataVisualization/DV_TProject1/02 Tableau/graph1.jpg)
```{r}
source('/Users/patriciaobrien/DataVisualization/DV_TProject1/03 R SQL Visualizations/DataWrangling1.R', echo=TRUE)
```
...
![](/Users/patriciaobrien/DataVisualization/DV_TProject1/02 Tableau/graph2.jpg)
```{r}
source('/Users/patriciaobrien/DataVisualization/DV_TProject1/03 R SQL Visualizations/DataWrangling2.R', echo=TRUE)
```
...
![](/Users/patriciaobrien/DataVisualization/DV_TProject1/02 Tableau/graph3.jpg)
```{r}
source('/Users/patriciaobrien/DataVisualization/DV_TProject1/03 R SQL Visualizations/DataWrangling3.R', echo=TRUE)
```
